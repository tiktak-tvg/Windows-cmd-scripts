...
'*****************************************************************
Const strResFile = "D:\public\Users_Computers.csv"
Set objRoot = GetObject("LDAP://RootDSE")
strDomName = objRoot.Get("DefaultNamingContext")
Set objRoot = Nothing
strAttributes = "cn,whenCreated"
arrCmdText = Array("<LDAP://" & strDomName & ">;(objectCategory=Computer);" & strAttributes & ";Subtree")
arrCapLines = Array("Компьютер")
...
For i = LBound(arrCmdText) To UBound(arrCmdText)
  ...
  If objRSet.RecordCount > 0 Then
    ...
    Do Until objRSet.EOF
      objFile.WriteLine(objRSet.Fields(0).Value)
      objRSet.MoveNext
    Loop
  End If
